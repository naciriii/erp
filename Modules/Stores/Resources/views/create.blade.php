            ...
            <div class="tile-body ">
             ...
             <div class="invalid-feedback">{{ $errors->first('name') }}</div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control{{ $errors->has('base_url') ? ' is-invalid' : '' }}" type="text" name="base_url" value="{{old('base_url')}}" placeholder="Enter Base Url">
             ...
             <div class="invalid-feedback">{{ $errors->first('base_url') }}</div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control{{ $errors->has('api_url') ? ' is-invalid' : '' }}" type="text" name="api_url" value="{{old('api_url')}}" placeholder="Enter Api Url">
