...
@section('content')
    <div class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post"
                      action="{{route('Store.Products.update',['id' => encode($store->id),'sku' => $product->sku])}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}"
                                           ...
                                           value="{{$product->extension_attributes->stock_item->qty}}" placeholder="">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-file" name="image" id="image" type="file" aria-describedby="fileHelp">
                                        @if ($errors->has('image'))
                                    ...
                                    <div class="form-group">
                                        <img src="{{$store->base_url.config('stores.api.public_resources').$product->media_gallery_entries[0]->file}}" alt="">
                                    </div>
                                    <input type="hidden" name="media_id" value="{{encode($product->media_gallery_entries[0]->id)}}">
                                </div>
                            </div>
                            </div>
