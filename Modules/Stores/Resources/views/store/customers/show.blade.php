...
@section('content')
    <div class="app-content" onload="initialize()">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post"
                      action="{{route('Store.Customers.update',['id' => encode($store->id),'customer'=> encode($customer->id)])}}">
                    {{csrf_field()}}
                    <div class="tile">
                                ...
                                <div class="col-sm col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}"
                                               ...
                                               value="{{$customer->lastname or old('last_name')}}" placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                               type="text" name="email" value="{{$customer->email or old('email')}}"
                                               placeholder="">
                                        @if ($errors->has('email'))
