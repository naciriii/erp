                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('name_prefix') ? ' is-invalid' : '' }}"
                                           type="text" name="name_prefix" value="{{old('name_prefix')}}" placeholder="">
                                ...
                                <div class="form-group">
                                    <label class="control-label">{{trans('stores::global. MiddleName/Initial')}}</label>
                                    <input class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}"
                                           type="text" name="middle_name" value="{{old('middle_name')}}" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('name_suffix') ? ' is-invalid' : '' }}"
                                           type="text" name="name_suffix" value="{{old('name_suffix')}}" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('birth_date') ? ' is-invalid' : '' }}"
                                           id="birth-date" type="text" placeholder="">
                                ...
                                <div class="form-group">
                                    <label class="control-label">{{trans('stores::global.Tax/VAT Number')}}</label>
                                    <input class="form-control{{ $errors->has('tax_vat') ? ' is-invalid' : '' }}"
                                           type="text" name="tax_vat" value="{{old('tax_vat')}}" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="gender" name="gender" class="form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}">
                                        <option value=""> </option>
                                        <option value="1">{{trans('stores::global.Male')}}</option>
                                        <option value="2">{{trans('stores::global.Female')}}</option>
                                        <option value="3">{{trans('stores::global.NotSpecified')}}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('street_address') ? ' is-invalid' : '' }}"
                                           type="text" name="street_address" value="{{old('street_address')}}" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('postal_code') ? ' is-invalid' : '' }}"
                                           type="text" name="postal_code" value="{{old('postal_code')}}" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}"
                                           type="text" name="phone_number" value="{{old('phone_number')}}" placeholder="">
